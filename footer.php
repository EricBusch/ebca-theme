	...
	<div class="default-width default-padding-x py-12">
		<div class="flex flex-col sm:flex-row items-center justify-between">
			<div class="flex flex-col space-y-1 text-center sm:text-left">
				<div class="font-heading uppercase tracking-widest text-sm"><?php echo get_bloginfo( 'name' ); ?> • Fine Art Photography</div>
				<div class="text-xs text-gray-600">&copy; <?php echo date_i18n( 'Y' ); ?> • All Rights Reserved</div>
			</div>
			<div class="flex flex-row items-center justify-center space-x-3 sm:justify-end">
				...
				<?php if ( $contact_email = get_field( 'contact_email', 'option' ) ) : ?>
					<a href="mailto:<?php esc_html_e( $contact_email ); ?>"
