			...
			<div class="flex flex-col items-start py-6 sm:flex-row sm:items-center sm:justify-between sm:py-12 default-width default-padding-x">
				...
				<div class="w-full sm:w-3/12">
					<h1 class="text-center sm:text-left">
						<a href="<?php echo get_bloginfo( 'url' ); ?>" title="Return to homepage" class="font-heading text-xl font-normal uppercase tracking-lg text-gray-700  w-full">Eric<span class="font-semibold">Busch</span> </a>
					</h1>
				</div>
				...
				<div class="bg-amber-40 w-full sm:w-3/12">
					<div class="flex flex-row items-center justify-center space-x-3 sm:justify-end">
						<a href="#" class="py-2 leading-none sm:py-1.5" target="_blank" rel="noopener">
							<svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 fill-gray-500" viewBox="0 0 448 512">
						...
						<a href="#" class="py-2 leading-none sm:py-1.5" target="_blank" rel="noopener">
							<svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 fill-gray-500" viewBox="0 0 512 512">
